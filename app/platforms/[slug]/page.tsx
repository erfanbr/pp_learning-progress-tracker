...
export default async function PlatformEditPage(myProp: Props) {
                ...
                <div className="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                    ...
                    <form action="#">
                        <div className="grid gap-4 mb-4 sm:grid-cols-2">
                            <div>
                                ...
                                <input type="text" name="id" id="id"
                                       className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-200 dark:border-gray-600 dark:placeholder-gray-400 dark:text-zinc-700 dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                       placeholder={platform!.id.toString()} disabled={true}/>
                            </div>
                            <div>
                                <label htmlFor="title"
                        ...
                        <div className="text-right">
                            <button className="p-2 mr-3 bg-amber-700 rounded-2xl border-2 border-amber-50">Delete</button>
                            <button className="p-2 bg-amber-700 rounded-2xl border-2 border-amber-50">Update Platform</button>
                            <button type="submit"
