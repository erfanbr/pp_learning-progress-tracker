            ...
            <div>
                ...
                <div className="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                    ...
                    <form action="#">
                        ...
                        {/*    <Button color="primary" className="rounded-2xl mx-2 text-right">Update</Button>*/}
                        {/*    <Button color="delete" className="rounded-2xl mx-2 text-right">Small</Button>*/}
                        {/*</div>*/}
                        <div className="text-right">
                            {/*<button className="p-2 mr-3 bg-amber-800 rounded-2xl border-2 border-amber-50">Delete</button>*/}
                            <button type="button"
                            ...
                            <button type="submit"
                                ...
                                <FaSave className="mr-1.5 -ml-1.5 w-5 h-5"/>
                                Save changes
                            </button>
                            <button type="submit"
                            ...
                            <p className="primary">This is test text</p>
