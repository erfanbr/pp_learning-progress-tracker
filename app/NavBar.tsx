            ...
            <aside id="default-sidebar"
                ...
                <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
                    ...
                    <Link href="#" className="flex items-center mx-2 border-b-2 mb-3 pb-5"><GiBookCover
                        className="w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"/><span
                        className="mx-3">Studyflow</span></Link>
