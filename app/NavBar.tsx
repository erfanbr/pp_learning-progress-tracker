...
export default function NavBar() {
    ...
    const links = [
        ...
        {label: "Schedule", href: "/", icon: <MdEvent className={sideBarIconStyle}/>},
        {label: "Performance", href: "/", icon: <CgPerformance className={sideBarIconStyle}/>},
        {label: "Notes", href: "/", icon: <MdSpeakerNotes className={sideBarIconStyle}/>},
        {label: "Settings", href: "/", icon: <MdSettingsApplications className={sideBarIconStyle}/>},
    ]
    return (
        <>
